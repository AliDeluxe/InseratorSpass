...
public final class AnzeigeErstellenServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (gesetzt == false) { //Falls was nicht richtig ist
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        anzeige.setTitel(titel); anzeige.setPreis(preis); anzeige.setBeschreibung(beschreibung);
        anzeige.setKategorien(kategorien); anzeige.setErstellungsDatum(currentDate);
        anzeige.setUser(currentUser);
